...
@section('content')
    ...
    <div class="span9">
        ...
        <p>
            ...
            tendencies - that is why our goods are so popular and we have a great number of faithful customers all over the country.
        </p>
        <hr class="soft" />
            ...
            <div class="tab-pane" id="listView">
                <div class="row">
                    ...
                    <div class="span4">
                        ...
                        <a class="btn btn-small pull-right" href="{{route('produitdetail')}}">View Details</a>
                        <br class="clr" />
                    </div>
                    <div class="span3 alignR">
                        <form class="form-horizontal qtyFrm">
                            ...
                            <a href="{{route('produitdetail')}}" class="btn btn-large btn-primary"> Add to
                                <i class=" icon-shopping-cart"></i>
                            </a>
                            <a href="{{route('produitdetail')}}" class="btn btn-large">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <h4 style="text-align:center">
                                    <a class="btn" href="{{route('produitdetail')}}">
                                        <i class="icon-zoom-in"></i>
                                    </a>
        ...
        <a href="{{route('comparer')}}" class="btn btn-large pull-right">Compair Product</a>
