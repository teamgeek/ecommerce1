    ...
    <div id="sidebar" class="span3">
        <div class="well well-small">
            <a id="myCart" href="{{route('produitdetail')}}">
        ...
        <ul id="sideManu" class="nav nav-tabs nav-stacked">
            <li class="subMenu open">
                ...
                <ul>
                    <li>
                        <a class="active" href="{{route('produit')}}">
            ...
            <li>
                <a href="{{route('produit')}}">HEALTH & BEAUTY [18]</a>
            </li>
            <li>
                <a href="{{route('produit')}}">SPORTS & LEISURE [58]</a>
            </li>
            <li>
                <a href="{{route('produit')}}">BOOKS & ENTERTAINMENTS [14]</a>
            </li>
        </ul>
        <br/>
        <div class="thumbnail">
