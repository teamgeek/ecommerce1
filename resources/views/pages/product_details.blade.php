...
@section('content')
    ...
    <div class="span9">
        <ul class="breadcrumb">
            ...
            <li>
                <a href="{{route('produit')}}">Products</a>
                <span class="divider">/</span>
            </li>
            ...
            <div class="span9">
                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane fade active in" id="home">
                        ...
                        <p>
                            14 Megapixels. 18.0 x Optical Zoom. 3.0-inch LCD Screen. Full HD photos and 1280 x 720p HD movie capture. ISO sensitivity
                            ISO6400 at reduced resolution. Tracking Auto Focus. Motion Panorama Mode. Face Detection technology with Blink
                            detection and Smile and shoot mode. 4 x AA batteries not included. WxDxH 110.2 ×81.4x73.4mm. Weight 0.341kg (excluding
                            battery and memory card). Weight 0.437kg (including battery and memory card).
                            <br/> OND363338
                        </p>
                        ...
                        <p>
                            ...
                            distance away. You can even operate the zoom during video shooting. Unlike a bulky D-SLR, bridge cameras allow
                            you great versatility of zoom, without the hassle of carrying a bag of lenses.
                        </p>
