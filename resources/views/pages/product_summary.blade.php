...
@section('content')
    ...
    <div class="span9">
        ...
        <h3> SHOPPING CART [
            ...
            <a href="{{route('produit')}}" class="btn btn-large pull-right">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                <td>
                    <img width="60" src="themes/images/products/4.jpg" alt="" />
                </td>
                <td>MASSA AST
            ...
            <tr>
                <td>
                    <img width="60" src="themes/images/products/8.jpg" alt="" />
                </td>
                <td>MASSA AST
                    <br/>Color : black, Material : metal</td>
                <td>
            ...
            <tr>
                <td>
                    <img width="60" src="themes/images/products/3.jpg" alt="" />
                </td>
                <td>MASSA AST
                    <br/>Color : black, Material : metal</td>
                <td>
        ...
        <a href="{{route('produit')}}" class="btn btn-large">
            <i class="icon-arrow-left"></i> Continue Shopping </a>
        <a href="login.html" class="btn btn-large pull-right">Next
